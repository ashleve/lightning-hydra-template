...
│   │
│   ├── logs                <- Logs generated by Weights&Biases and PyTorch Lightning during training
│   │
...
│   │   │   ├── lightning_module.py         <- Contains train/val/test step methods executed during training
