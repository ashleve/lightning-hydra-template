...
minst_train_preprocess = transforms.Compose([
    transforms.ToTensor(),
])

mnist_test_preprocess = transforms.Compose([
    transforms.ToTensor()
])
...
imagenet_train_preprocess = transforms.Compose([
...
imagenet_test_preprocess = transforms.Compose([
...
cifar10_test_preprocess = transforms.Compose([
    transforms.ToTensor(),
])
