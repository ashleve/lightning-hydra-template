...
logger=wandb logger.wandb.project_name="env_tests" logger.wandb.group="HydraSweep_MNIST_SimpleDenseNet_seed12345"
...
logger=wandb logger.wandb.project_name="env_tests" logger.wandb.group="Optuna_MNIST_SimpleDenseNet_seed12345"
