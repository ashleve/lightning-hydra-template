...
class IceCubeDatamodule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if not self.train_datapipe or not self.train_datapipe or not self.test_datapipe: #why not or?
            self.train_datapipe, self.val_datapipe, self.test_datapipe= make_train_test_val_datapipe(
